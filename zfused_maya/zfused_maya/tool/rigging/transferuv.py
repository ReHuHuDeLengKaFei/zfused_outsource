...
import zfused_maya.ui.widgets.window as win
...
class PolyTransfer():
    ...
    def showUI(self):
        ...
        cmds.setParent(PrimaryLayout)
        assignButton = cmds.button(l = u'传递', c = lambda *args: self.transferUV(), h = 30)
        ...
        cmds.button(l = u'传递', c = lambda *args: self.secTransferUV(), h = 30)
