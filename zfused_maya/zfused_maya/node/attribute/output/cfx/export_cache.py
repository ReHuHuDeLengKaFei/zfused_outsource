...
from zfused_maya.node.core import alembiccache, fixmeshname, renderinggroup, xgen, displaylayer
...
def export_cache(*args, **kwargs):
    ...
    if _grow_mesh_grps:
        for grow_mesh_grp in _grow_mesh_grps:
            ...
            _abc_job = alembiccache.create_frame_cache(_publish_file, _start_frame, _end_frame, grow_mesh_grp, *EXPORTATTR, **_extend_attr)
        ...
        for _description in _all_descriptions:
            ...
            if _out_curves:
                ...
                outcurve_publish_file = '{}/{}/{}_{}_{}.{}{}'.format(_publish_path, curve_attr_code, outcurve_short_ns,
                                                                     ...
                                                                     _file_index,
                                                                     _suffix)
                _abc_job = alembiccache.create_frame_cache(outcurve_publish_file, _start_frame, _end_frame, _out_curves,*EXPORTATTR,**_extend_attr)
                _abc_jobs.append(_abc_job)
    ...
    if _all_palettes:
        for _pallette in _all_palettes:
            ...
            _abc_job = alembiccache.create_xgen_frame_cache(_publish_file, _start_frame, _end_frame, _pallette, *EXPORTATTR, **_extend_attr)
