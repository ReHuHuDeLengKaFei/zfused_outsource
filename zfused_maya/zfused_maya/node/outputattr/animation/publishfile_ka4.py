...
def publish_file(*args, **kwargs):
    ...
    ##print("_temp_path:{}_step_code:{}_software_code:{}_attr_code:{}_file_code:{}_file_index:{}_suffix:{}_production_path:{}".format(_temp_path,_step_code,_software_code,_attr_code,_file_code,_file_index,_suffix,_production_path))
