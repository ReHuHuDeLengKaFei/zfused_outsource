...
def publish_file(*args, **kwargs):
    ...
    try:
        ...
        if _alembic_files:
            ...
            _intersection_path = max(_path_set)
            alembiccache.publish_file(_alembic_files, _intersection_path, _publish_file_dir + "/cache/alembic")
            _file_nodes = alembiccache.nodes()
            if _file_nodes:
                alembiccache.change_node_path(_file_nodes, _intersection_path, _publish_file_dir + "/cache/alembic")
