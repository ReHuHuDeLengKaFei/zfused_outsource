...
class WSGIHandler(object):
    ...
    def finalize_headers(self):
        ...
        if self.code not in (304, 204):
            # the reply will include socket-body; make sure we have either Content-Length or chunked
...
class LoggingLogAdapter(object):
    ...
    .. versionchanged:: 1.1
       Strip trailing newline characters on the socket passed to :meth:`write`
