...
class AssemblyStepWidget(QtWidgets.QFrame):
    reference_version = QtCore.Signal(int)
    def __init__(self, parent=None):
        super(AssemblyStepWidget, self).__init__(parent)
        self._build()

        self._assembly_id = 0
        self._assembly_handle = None
    ...
    def load_project_step_id(self, project_step_id):
        ...
        if not project_step_id or not self._assembly_id:
            return 
        ...
        # project version
        _versions = self._assembly_handle.project_step_versions(project_step_id)
        _versions.reverse()
    ...
    def load_assembly_id(self, assembly_id):
        ...
        if not assembly_id:
            ...
            self.show()
        self._assembly_handle = zfused_api.assembly.Assembly(assembly_id)
