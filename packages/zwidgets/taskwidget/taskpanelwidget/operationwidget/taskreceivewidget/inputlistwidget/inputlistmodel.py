...
from Qt import QtWidgets, QtGui, QtCore# coding:utf-8
...
class InputFilterProxyModel(QtCore.QSortFilterProxyModel):
    def __init__(self, parent=None):
        super(InputFilterProxyModel, self).__init__(parent)
    ...
    def _search(self, data):
        ...
        _link_handle = zfused_api.objects.Objects(data["ProjectEntityType"], data["ProjectEntityId"])
        _in_link_name = self._search_text.lower() in _link_handle.name_code().lower()
