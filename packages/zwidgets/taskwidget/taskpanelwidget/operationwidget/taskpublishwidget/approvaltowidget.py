...
class ApprovalToWidget(QtWidgets.QFrame):
    def __init__(self, parent=None):
        super(ApprovalToWidget, self).__init__(parent)
        self._build()
    ...
    def _build(self):
        ...
        self.subbject_button.setObjectName("approval_to_name")
        self.subbject_button.setMinimumWidth(120)
        self.subbject_button.setMaximumWidth(120)
        self.subbject_button.setText(u"审核人：")
        self.subbject_button.setIcon(QtGui.QIcon(resource.get("icons","approval.png")))
