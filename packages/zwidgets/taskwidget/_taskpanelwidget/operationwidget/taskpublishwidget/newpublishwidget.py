...
class NewPublishWidget(QtWidgets.QFrame):
    ...
    def _publish(self):
        ...
        if not _check_value:
            ...
            return 
        self.published.emit("new", self._task_id, self.base_widget.infomation())

    # def _publish_batch_mode(self):
    #     self.info_widget.setHidden(True)
    #     # check info
    #     _check_value = self._check()
    #     if not _check_value:
    ...
    #         return 
    #     # check file
    #     _task_handle = zfused_api.task.Task(self._task_id)
    #     _link_handle = zfused_api.objects.Objects(_task_handle.data()["Object"], 
